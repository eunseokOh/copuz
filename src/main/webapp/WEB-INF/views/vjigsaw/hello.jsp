...
<head>
    ...
    <meta property="og:image" content="http://dl.dropbox.com/u/5728198/html5puzzle/./resources/test/content/puzzle.jpg">
    ...
    <link href="./resources/test/Puzzle.css" rel="stylesheet" type="text/css" />
    <script src="./resources/test/jquery-1.7.2.min.js" type="text/javascript"></script>
    <script src="./resources/test/paper.js" type="text/javascript"></script>
    <script type="text/paperscript" canvas="canvas">
        ...
        $('.zoomIn').click(function() { // 확대
            puzzle.zoom(.1);
        });

        $('.zoomOut').click(function() { //축소
            puzzle.zoom(-.1);
        });

        $('.help').mousedown(function() { // 이미지 보기
...
<body>
    <img width="920" height="120" src="./resources/test/content/logo.png" class="logo"/>
    <canvas id="canvas" class="canvas" resize></canvas>
    <div class="charms">
        <img width="50" height="50" src="./resources/test/content/zoomIn.png" class="zoomIn"/>
        <img width="50" height="50" src="./resources/test/content/zoomOut.png" class="zoomOut"/>
        <img width="50" height="50" src="./resources/test/content/help.png" class="help"/>
    </div>
    
    
    

    <img width="1000" height="900" id="puzzle-image" class="puzzle-image" style="display: none;" src="./resources/test/content/avengers.jpg" />
    <img width="128" height="128" id="empty" style="display: none;" src="./resources/test/content/empty.png" />
</body>
</html>
